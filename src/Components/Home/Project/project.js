    ...
    <div>
      <div className='project' id='project'>
        <Container>
            ...
            <div className='col-lg-6 col-md-12 col-sm-12'>
                <div className='project-img'>
                    <img src={img5} alt='web'/>
                </div>
            </div>
            <div className='col-lg-6 col-md-12 col-sm-12'>
                <div className='project-content'>
                    <h4>Travel-Destiny Website</h4>
                    <div className='dev d-flex'>
                        <p className='react'>React</p>
                        <p className='css'>Css</p>
                        <p className='bootstrap'>Bootstrap</p>
                    ...
                    <div className='link'>
                       <p><a href='https://travel-destiny.netlify.app/' target='blank'> Visit Here <i class="fa-solid fa-truck-fast"></i><i class="fa-solid fa-arrow-right"></i></a></p>
                    </div>
                </div>
            </div>
            </div>
